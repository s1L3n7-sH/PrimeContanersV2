      ...
      <div className="md:max-w-frame mx-auto px-4 h-[100vh]">
        <section className="max-w-frame px-4 flex flex-col items-center text-center">
          ...
          >
            <Link
              href="/shop"
              className="w-full md:w-52 mb-5 md:mb-12 inline-block text-center bg-yellow-400 text-black hover:bg-yellow-500 transition-all duration-300 font-medium px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition duration-300 ease-in-out"
            >
              Buy Now
            </Link>
          </motion.div>
